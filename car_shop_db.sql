...
--
-- Host: localhost    Database: car_shop_db
-- ------------------------------------------------------
...
CREATE TABLE `car_parts` (
  ...
  `buying_price` decimal(7,2) DEFAULT NULL,
  `client_price` decimal(7,2) DEFAULT NULL,
  `application` varchar(200) DEFAULT NULL,
  `year` int DEFAULT NULL,
  `manufactor` varchar(200) DEFAULT NULL,
...
-- Dump completed on 2021-07-02 18:49:38
